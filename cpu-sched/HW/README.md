1.  
```sh
jacky@MacBook-Pro-2 cpu-sched % ./scheduler.py -p FIFO -l 200,200,200 -c
ARG policy FIFO
...
jacky@MacBook-Pro-2 cpu-sched % ./scheduler.py -p SJF -l 200,200,200 -c
ARG policy SJF
ARG jlist 200,200,200
...
2.  
```sh
jacky@MacBook-Pro-2 cpu-sched % ./scheduler.py -p FIFO -l 100,200,300 -c
ARG policy FIFO
...
jacky@MacBook-Pro-2 cpu-sched % ./scheduler.py -p SJF -l 100,200,300 -c
ARG policy SJF
ARG jlist 100,200,300
...
3.  
```sh
jacky@MacBook-Pro-2 cpu-sched % ./scheduler.py -p RR -q 1 -l 100,200,300 -c
ARG policy RR
ARG jlist 100,200,300
...
```  
4. job時長由小到大處理時，FIFO 和 SJF有相同的turnaround。  
5. 當量子長度大於最長job時長時，RR 和 SJF相同。  
6. response time會變長。  
7. 量子長度增加，response time也會增加。
